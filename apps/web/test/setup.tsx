...
vi.mock('@phosphor-icons/react', () => ({
  ...
  IslandIcon: (props: Record<string, unknown>) => <svg {...props} />,
  LinkIcon: (props: Record<string, unknown>) => <svg {...props} />,
  ListChecksIcon: (props: Record<string, unknown>) => <svg {...props} />,
  ...
  MapPinIcon: (props: Record<string, unknown>) => <svg {...props} />,
  MapTrifoldIcon: (props: Record<string, unknown>) => <svg {...props} />,
  MegaphoneIcon: (props: Record<string, unknown>) => <svg {...props} />,
  MoonIcon: (props: Record<string, unknown>) => <svg {...props} />,
  MountainsIcon: (props: Record<string, unknown>) => <svg {...props} />,
  ...
  SuitcaseRollingIcon: (props: Record<string, unknown>) => <svg {...props} />,
  SunDimIcon: (props: Record<string, unknown>) => <svg {...props} />,
  TableIcon: (props: Record<string, unknown>) => <svg {...props} />,
  TentIcon: (props: Record<string, unknown>) => <svg {...props} />,
  ...
  UmbrellaIcon: (props: Record<string, unknown>) => <svg {...props} />,
