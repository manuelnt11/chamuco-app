...
- `TripsController.exportItineraryPdf` (function) — streams the trip itinerary PDF generated by `TripItineraryPdfService.generate`, setting `Content-Type: application/pdf` and a `Content-Disposition` attachment header
