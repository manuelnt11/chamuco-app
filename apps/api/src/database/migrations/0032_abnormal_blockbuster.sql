...
ALTER TABLE "trip_participants" ADD CONSTRAINT "trip_participants_initiated_by_users_id_fk" FOREIGN KEY ("initiated_by") REFERENCES "public"."users"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "trip_participants" ADD CONSTRAINT "trip_participants_decided_by_users_id_fk" FOREIGN KEY ("decided_by") REFERENCES "public"."users"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
CREATE INDEX "idx_trip_participants_user_id_status" ON "trip_participants" USING btree ("user_id","status");--> statement-breakpoint
CREATE INDEX "idx_trip_participants_trip_id_status" ON "trip_participants" USING btree ("trip_id","status");
--> statement-breakpoint
